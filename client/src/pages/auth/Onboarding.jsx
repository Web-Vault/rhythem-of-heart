    ...
    <div className="flex items-center justify-center mb-8">
      {steps.map((s, idx) => (
        <div key={s.title} className="flex items-center">
          <div className={`onboarding-step-circle w-8 h-8 rounded-full flex items-center justify-center font-bold text-base border-2 transition-all duration-300 ${
            idx < step
          ...
          {idx < steps.length - 1 && (
            <div className={`onboarding-step-bar h-1 w-8 md:w-16 mx-1 md:mx-2 rounded ${
              idx < step
